...
public class BoardListController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		int currentPage; // 현재 페이지 몇 쪽?(== 사용자가 요청한 페이지)
...
//		System.out.println("개수 : " + listCount);
		 ...
		 * 
		 * listCount | boardLimit maxPage 100 / 10 => 10.00 10
		 * 
		 * 101 / 10 => 10.xx 11 102 / 10 => 10.xx 11 103 / 10 => 10.xx 11 104 / 10 =>
		 * 10.xx 11 105 / 10 => 10.xx 11 110 / 10 => 11.00 11
		 * 
		 * 111 / 10 => 11.xx 12
		 *
		 ...
		 * startPage : 페이징바의 시작
		 *
		 * pageLimit(페이지 하단에 보여질 페이지 버튼의 최대 개수), currentPage(현재 페이지) 위 두개의 값을 이용하여 구할 수
		 * 있음
		 * 
		 * ex) 페이징바의 목록이 10개 단위라는 가정 하에, startPage : 1, 11, 21, 31, 41, 51... : 10n + 1
		 * : pageLimit * n + 1
		 * 
		 * 
		 * currentPage startPage N * pageLimit + 1
		 * 
		 * 1 1 => 0 * pageLimit + 1 5 1 => 0 * pageLimit + 1 N = 0 10 1 => 0 * pageLimit
		 * + 1
		 * 
		 * 11 11 => 1 * pageLimit + 1 15 11 => 1 * pageLimit + 1 N = 1 20 11 => 1 *
		 * pageLimit + 1
		 * 
		 * 
		 ...
		 * 
		 * 
		 * currentPage-1 / pageLimit => n 0~9 / 10 => 0 10~19 / 10 => 1 20~20 / 10 => 2
		 * 
		 * 
		 ...
		 * endPage : 페이징바의 끝
		 * 
		 * startPage , pageLimit, (+maxPage) 위 3개 값의 영향을 받음
		 * 
		...
		// 변수 많으니까,, 객체에 담아서 보내기,, -> vo에 페이지 관련 변수 담기
		...
		// 게시글 관련 데이터 준비 -> 데이터 조회하기 / 한 페이지에 보여지는 10개의 게시글만 조회하기
